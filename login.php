   ...
   <div class="container">
	  <div class="row">
		...
		<div class="wow fadeInUp col-md-6 col-sm-12" data-wow-delay="1.6s">
			<h1>Let's continue where we left!</h1>
			<div class="contact-form">
				<form id="contact-form" method="post" action="login_redirect.php" onSubmit="return check();">
			...
			<p><a href="login-org.php">Organisation Login</a></p>
		</div>
