...
include("header.php");
include("logged.php");
$query = "SELECT P.name AS name, P.projid AS projid, W.skill AS skill FROM projects AS P INNER JOIN (SELECT skill, projid FROM works WHERE userid = $_SESSION[userid]) AS W ON P.projid = W.projid; ";
...
-->
	...
	<!-- Site title
   ================================================== -->
	<title>My Projects - Work & Worth</title>
		...
		<div class="row">
			<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8">
          		<div class="header-thumb">
              		<h1 class="wow fadeIn" data-wow-delay="1.6s">My Projects</h1>
              		<h3 class="wow fadeInUp" data-wow-delay="1.9s">A community for people like us</h3>
          		</div>
			</div>
		</div>
	</div>		
                            ...
                            <?php
                            	for($i = 0; $i < count($projects); $i++)
                                {
                                	echo '<div class="iso-box ' . clean((string)$projects[$i]["skill"]) . ' col-md-4 col-sm-6">';
                                  	...
                                  	echo '<a href="project-updates.php?projid=' . (string)$projects[$i]["projid"] . '"><i class="fa fa-link"></i></a>';
